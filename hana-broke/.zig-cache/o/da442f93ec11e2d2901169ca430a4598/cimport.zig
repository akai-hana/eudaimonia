...
pub const struct_xkb_context = opaque {
    ...
    pub const data = __root.xkb_context_set_user_data;
    pub const append = __root.xkb_context_include_path_append;
    pub const default = __root.xkb_context_include_path_append_default;
    pub const defaults = __root.xkb_context_include_path_reset_defaults;
    pub const clear = __root.xkb_context_include_path_clear;
    pub const paths = __root.xkb_context_num_include_paths;
    pub const get = __root.xkb_context_include_path_get;
    pub const level = __root.xkb_context_set_log_level;
    pub const verbosity = __root.xkb_context_set_log_verbosity;
    pub const @"fn" = __root.xkb_context_set_log_fn;
...
pub const struct_xkb_rmlvo_builder = opaque {
    ...
    pub const layout = __root.xkb_rmlvo_builder_append_layout;
    pub const option = __root.xkb_rmlvo_builder_append_option;
...
pub const struct_xkb_keymap = opaque {
    ...
    pub const string = __root.xkb_keymap_get_as_string;
    pub const string2 = __root.xkb_keymap_get_as_string2;
    pub const keycode = __root.xkb_keymap_min_keycode;
    pub const each = __root.xkb_keymap_key_for_each;
    pub const name = __root.xkb_keymap_key_get_name;
    pub const mods = __root.xkb_keymap_num_mods;
    pub const index = __root.xkb_keymap_mod_get_index;
    pub const mask = __root.xkb_keymap_mod_get_mask;
    pub const mask2 = __root.xkb_keymap_mod_get_mask2;
    pub const layouts = __root.xkb_keymap_num_layouts;
    pub const leds = __root.xkb_keymap_num_leds;
    pub const key = __root.xkb_keymap_num_layouts_for_key;
    pub const level = __root.xkb_keymap_key_get_mods_for_level;
    pub const repeats = __root.xkb_keymap_key_repeats;
...
pub const struct_xkb_state = opaque {
    ...
    pub const keymap = __root.xkb_state_get_keymap;
    pub const key = __root.xkb_state_update_key;
    pub const locked = __root.xkb_state_update_latched_locked;
    pub const mask = __root.xkb_state_update_mask;
    pub const syms = __root.xkb_state_key_get_syms;
    pub const utf8 = __root.xkb_state_key_get_utf8;
    pub const utf32 = __root.xkb_state_key_get_utf32;
    pub const sym = __root.xkb_state_key_get_one_sym;
    pub const layout = __root.xkb_state_key_get_layout;
    pub const level = __root.xkb_state_key_get_level;
    pub const mods = __root.xkb_state_serialize_mods;
    pub const active = __root.xkb_state_mod_name_is_active;
    pub const mods2 = __root.xkb_state_key_get_consumed_mods2;
    pub const consumed2 = __root.xkb_state_mod_index_is_consumed2;
    pub const consumed = __root.xkb_state_mod_index_is_consumed;
};
...
pub fn __bswap16(arg___x: u16) callconv(.c) u16 {
    var __x = arg___x;
    _ = &__x;
    return @bitCast(@as(c_short, @truncate((@as(c_int, __x) << @intCast(8)) | (@as(c_int, __x) >> @intCast(8)))));
}
pub fn __bswap32(arg___x: u32) callconv(.c) u32 {
    var __x = arg___x;
    _ = &__x;
    return (((__x >> @intCast(24)) | ((__x >> @intCast(8)) & @as(u32, 65280))) | ((__x << @intCast(8)) & @as(u32, 16711680))) | (__x << @intCast(24));
}
pub fn __bswap64(arg___x: u64) callconv(.c) u64 {
    var __x = arg___x;
    _ = &__x;
    return @truncate(((@as(c_ulonglong, __bswap32(@truncate(__x))) +% @as(c_ulonglong, 0)) << @intCast(32)) | @as(c_ulonglong, __bswap32(@truncate(__x >> @intCast(32)))));
}
...
pub extern fn timer_settime(timer_t, c_int, noalias [*c]const struct_itimerspec, noalias ?*struct_itimerspec) c_int;
...
pub inline fn XCB_TYPE_PAD(T: anytype, I: anytype) @TypeOf(-I & (if (__helpers.sizeof(T) > @as(c_int, 4)) @as(c_int, 3) else __helpers.sizeof(T) - @as(c_int, 1))) {
    _ = &T;
    _ = &I;
    return -I & (if (__helpers.sizeof(T) > @as(c_int, 4)) @as(c_int, 3) else __helpers.sizeof(T) - @as(c_int, 1));
}
